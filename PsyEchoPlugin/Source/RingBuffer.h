...
public:
        ...
        xcoordinate(0)
    {
        ...
        xcoordinate     = new int[m_iBuffLength];
...
//    }
    ...
    */
    ...
    // fOffset is the actual delay time in samples if not equal to 0
    T get (float fOffset = 0) const
    {
        ...
        else
        {
            ...
            return lagrangeInterp<T>(xcoordinate, m_ptBuff, 8, fOffset);
        }
    }
    
    // get past samples
    float getPastSamples(int nPastSample)
    {

...
NewProjectAudioProcessorEditor::NewProjectAudioProcessorEditor (NewProjectAudioProcessor* ownerFilter)
   : AudioProcessorEditor (ownerFilter),
     title("","PSYeCHO!"),
     FBLabel("","FeedBack Gain:"),
     intensityLabel("","Intensity:"),
     RrateLabel("","Repeat Rate:"),
     ReverbLabel("","Reverb Volume:"),
     ModeLabel("","Mode Selector:"),
     FBGainSlider("Feedback"),
     intensitySlider("Intensity"),
     RrateSlider("RepeatRate"),
     ReverbSlider("Reverb"),
     ModeSlider("Mode"),
     BypassButton("Bypass"),
     OldButton("Old")

{
    ...
    FBGainSlider.setRange(0.0, 1.0,0.1);
    ...
    RrateSlider.setRange(0.0, 100.0,0.1);
    ...
    BypassButton.setButtonText("Bypass ON/OFF");
...
void NewProjectAudioProcessorEditor::buttonClicked(Button *button)
{
    ...
    {
        getProcessor()->setParameterNotifyingHost(NewProjectAudioProcessor::bypassParam, (float)BypassButton.getToggleState());
    }
    if (button == &OldButton) {
        Old = !Old;
    }
...
void NewProjectAudioProcessorEditor::timerCallback()
{
    ...
    BypassButton.setToggleState(true == ourProcessor->bypass, dontSendNotification);
    OldButton.setToggleState(true == ourProcessor->old, dontSendNotification);
}
...
void NewProjectAudioProcessorEditor::resized()
{
    ...
    BypassButton.setBounds(200, 450, 100, 40);
    OldButton.setBounds(400, 450, 40, 40);
